...
export const discussionPostSchema = z.object({
    ...
    description: z.string().min(5, "Description is too short").max(5000, "Description is too long (max 5000 characters)").trim(),
    tags: z.array(
    ...
    userName : z.string().min(3,"Please keep username of minimum 3 characters")
});