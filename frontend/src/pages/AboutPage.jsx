...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-[#FDFDFF] text-slate-900 selection:bg-indigo-100 selection:text-indigo-700 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <aside className="lg:col-span-4 space-y-10">
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div>
                <h1 className="text-3xl font-black tracking-tight text-slate-900">Pranava Pai N</h1>
              ...
              <div className="flex flex-wrap gap-2 justify-center lg:justify-start pt-4">
                {Object.entries({
                  ...
                  Portfolio : "https://simple-portfolio-website-indol.vercel.app"
                }).map(([platform, url]) => (
                  <a
                    key={platform}
                    href={url}
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <section className="space-y-6">
              <h2 className="inline-flex items-center gap-2 text-xs font-black text-indigo-500 uppercase tracking-[0.3em]">
                <UserIcon className="w-4 h-4" /> About Me
              </h2>
              <p className="text-2xl md:text-3xl font-bold text-slate-900 leading-tight">
                I build digital products that balance <span className="text-indigo-600">performance</span> with professional user interfaces.
              </p>
              <div className="space-y-4 text-slate-600 leading-relaxed max-w-2xl">
                <p>
                  With over 3 years of experience in engineering, I specialize in crafting scalable web applications using React, Node.js, and specialized cloud architectures. 
                </p>
                <p>
                  When I'm not coding, I'm likely exploring open-source contributions or exploring recent advanced technologies with interest in Data Structures and Algorithms.
                </p>
              </div>
            </section>
